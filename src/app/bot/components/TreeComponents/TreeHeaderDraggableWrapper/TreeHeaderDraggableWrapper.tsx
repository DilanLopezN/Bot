...
class TreeHeaderDraggableWrapperClass extends Component<TreeHeaderDraggableWrapperProps, any>{
    render() {
        ...
        return connectDragSource(<div className="DraggableWrapper" id={this.props.interaction?._id}>
            <TreeHeader isExecuting={this.props.isExecuting} interaction={this.props.interaction} />
        </div>)
    }
}

const TreeHeaderDraggableWrapperDraggable = DragSource("INTERACTION", {
...
export const TreeHeaderDraggableWrapper = connect(
    mapStateToProps,
    {}
)(TreeHeaderDraggableWrapperDraggable);
