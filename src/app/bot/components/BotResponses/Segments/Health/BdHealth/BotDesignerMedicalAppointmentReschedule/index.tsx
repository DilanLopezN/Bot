...
import { BotDesignerMedicalAppointmentRescheduleProps } from './props';
...
export default class BotDesignerResponseMedicalAppointmentRescheduleClass extends Component<BotDesignerMedicalAppointmentRescheduleProps> {
    private translation: GetArrayWords;

    constructor(props: Readonly<BotDesignerMedicalAppointmentRescheduleProps>) {
        super(props);
...
export const BotDesignerResponseMedicalAppointmentReschedule = i18n(
    withRouter(connect(mapStateToProps, {})(BotDesignerResponseMedicalAppointmentRescheduleClass))
);
